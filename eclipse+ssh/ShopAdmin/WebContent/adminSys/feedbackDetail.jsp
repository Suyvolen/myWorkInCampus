	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Feedback Detail Table</h1>
						<h1 class="page-subhead-line">For feedback details.</h1>
						...
						<div class="panel panel-danger">
							...
							<div class="panel-body">
								<s:form role="form">
									...
									<div class="form-group">
										<label>主题</label> <input class="form-control" type="text"
											value="${feedback.subject}">
									</div>
									<div class="form-group">
										<label>内容</label> 
										<textarea class="form-control"
										 style="height:150px">${feedback.propose}</textarea>
									</div>
								</s:form>
							</div>
						</div>
