...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <s:form class="form-horizontal" action="register" method="post">
	 <h4>Your personal information</h4>
	 </td><td><s:select name="customer.sex" class="span2" label="Sex" list="#{'0':'Mr.','1':'Mrs'}"   />
	 <s:textfield name="customer.account" class="span3" label="Username" placeholder="Username" />
	 <s:password name="customer.password" class="span3" label="Password" placeholder="Password" />
	 <s:textfield name="customer.email" class="span4" label="Email" placeholder="Email" />
	 <s:textfield name="customer.phone" class="span3" label="Phone" placeholder="Phone" />
	 <s:textarea name="customer.address" class="input-xxsmall" rows="3" label="Address" placeholder="Address" />
	 <s:submit name="register" value="register" class="btn btn-large btn-success" />
	 </s:form>
</div>
