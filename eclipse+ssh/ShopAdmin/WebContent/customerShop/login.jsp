...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span4">
			...
			Click here to create your account.<br/><br/><br/>
		...
		<div class="span4">
			...
			<s:label value="Username" class="control-label" />
			<s:textfield name="customer.account" placeholder="Username" class="span3"/>
			<s:label value="Password" class="control-label"/>
			<s:password name="customer.password" placeholder="Password" class="span3"/>
