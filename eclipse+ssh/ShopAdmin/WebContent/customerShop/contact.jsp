...
<div class="container">
	...
	<div class="row">
		...
		<div class="span4">
		<h4>Email Us</h4>
		<s:form action="customerFeed" method="post">
		<s:textfield name="feedback.name" placeholder="name" class="input-xlarge" />
		<s:textfield name="feedback.email" placeholder="email" class="input-xlarge" />
		<s:textfield name="feedback.subject" placeholder="subject" class="input-xlarge" />
		<s:textarea  name="feedback.propose" rows="3" class="input-xlarge" />
		<s:submit class="btn btn-large" value="Send Messages"/>
		</s:form>
		</div>
	</div>
	<div class="row">
