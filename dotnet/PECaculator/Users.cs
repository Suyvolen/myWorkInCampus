...
namespace PhysicalFitnessTest
{
    ...
    public class Data
    {
        ...
        //从数据库读Data
        public Data(String Name, DateTime saveDate, double sumScore, double height, double weight, int vitalCapacity, double sitAndReach, double standingLeap, double shortRun, double longRun, int chinningOrSitUp)
        {
            User = new Users();
            User.Name= Name;
            SaveDate = saveDate;
        ...
        //用户构造
        public Data(Users user, DateTime saveDate, double sumScore,double height, double weight, int vitalCapacity, double sitAndReach, double standingLeap, double shortRun, double longRun, int chinningOrSitUp)
        {
            User = user;
            SaveDate = saveDate;
            SumScore = sumScore;
        ...
        public Users UserInfprmation { get => User; set => User = value; }
