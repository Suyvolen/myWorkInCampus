...
public class Menu : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        string directoryPath = "Assets/Charts";
        try
        {
        ...
        for (int i = 0; i < charts.Count; i++)
        {
            ...
            using (StreamReader sr = File.OpenText(charts[i]))
            {
                ...
                tmp_chart.id = int.Parse(sr.ReadLine());
    ...
    private void decide()
    {
        ...
        PlayerPrefs.SetInt("id", charts_data[cursor].id);
    ...
    private void OnGUI()
    {
        ...
        for (int i = start_idx; i < charts_data.Count && i < start_idx + max_list; i++)
        {
            ...
            if (i == cursor)
            {
                ...
                drawer_y += chart_size;
                desc_string = charts_data[i].id.ToString();
        ...
        fStyle.normal.background = black_tex;
        //GUI.Button(new Rect(0, -100, 0, 0), "Best Score : " + charts_data[cursor].best_score, fStyle);
